# Откройте http://parsinger.ru/infiniti_scroll_1/ с помощью Selenium;
...
with webdriver.Chrome() as browser:
    ...
    flag = False
    while True:
        items = [x for x in browser.find_element(By.ID, "scroll-container").find_elements(By.TAG_NAME, "span")]
        for item in items:
